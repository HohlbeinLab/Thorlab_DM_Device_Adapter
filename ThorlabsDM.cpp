...
{	
   ...
   assert(nRet == DEVICE_OK);
	...
	//if (DEVICE_OK != nRet)	return nRet;
 //Tilt segments voltage with AMPLITUDE & ANGLE
...
//Reset zernikes value to 0 and all segments to 100v
  ...
  //This option was added due to connection with REALM
